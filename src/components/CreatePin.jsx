...
const CreatePin = ({ user }) => {
  ...
  const uploadImage = (e) => {
    ...
    if (type === 'image/png' || type === 'image/jpeg' || type === 'image/svg' || type === 'gif' || type === 'tiff') {
      ...
      <div className='flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
        ...
        <div className='flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full'>
          <input type="text"
            ...
            className='outline-none text-2xl sm:text-3xl font-bold border-b-2 border-r-gray-200 p-2'
          />
          {user && (
          ...
          <input type="text"
            ...
            className='outline-none text-base sm:text-lg border-b-2 border-r-gray-200 p-2'
          />
          <input type="text"
            value={destination}
